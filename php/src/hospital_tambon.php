...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<form method="post" enctype="multipart/form-data" name="form1" id="form1" action="ServiceForm_tambon.php">
		  ...
		  <h5><i class='fas fa-edit'></i> 1. บริการจิตเวชฉุกเฉิน</h5>
			...
			<div class="card card-outline card-primary">
				...
				<div class="card-body">
					...
					<span>
					  <input type="checkbox" name="qus2_1_8" class="flat-red" value="1">&nbsp; 
					  มีบริการบำบัดผู้ป่วยยาเสพติด ( Motivation interview : MI )
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_1_9" class="flat-red" value="1">&nbsp; 
					  มีบริการรับยาจิตเวชต่อเนื่องที่ รพ.สต.
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_1_10" class="flat-red" value="1">&nbsp; 
					  มีบริการฉีดยาจิตเวชชนิดออกฤทธิ์ระยะยาว
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_1_11" class="flat-red" value="1">&nbsp; 
					  บริการสนับสนุนการตรวจรักษาจิตเวชทางไกล (Telepsychiatry)
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_1_12" class="flat-red" value="1">&nbsp; 
			...
			<div class="card card-outline card-primary">
				...
				<div class="card-body">
					...
					<input type="checkbox" name="qus2_2_1" class="flat-red" value="1">&nbsp;  
			...
			<div class="card card-outline card-primary">
				...
				<div class="card-body">
					<span>
					  <input type="checkbox" name="qus2_2_1_1" class="flat-red" value="1">&nbsp; 
					  การรับฟังเชิงลึก (Deep Listening)
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_2_1_2" class="flat-red" value="1">&nbsp; 
					  การให้การปรึกษาด้านสุขภาพจิต (Mental Health Counseling/ Strength Based Counseling)
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_2_1_3" class="flat-red" value="1">&nbsp; 
					  การสนทนาสร้างแรงจูงใจเพื่อการปรับเปลี่ยนพฤติกรรม (MI)
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_2_1_4" class="flat-red" value="1">&nbsp; 
			...
			<div class="card card-outline card-primary">
				...
				<div class="card-body">
					<span>
					  <input type="checkbox" name="qus2_2_2_1" class="flat-red" value="1">&nbsp; 
					  การรับฟังเชิงลึก (Deep Listening)
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_2_2_2" class="flat-red" value="1">&nbsp; 
					  การค้นหา/ คัดกรองผู้มีปัญหาสุขภาพจิตและพัฒนาการ
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_2_2_3" class="flat-red" value="1">&nbsp; 
			...
			<div class="card card-outline card-primary">
				...
				<div class="card-body">
					<span>
					  <input type="checkbox" name="qus2_3_1" class="flat-red" value="1">&nbsp; 
					  มีแบบประเมิน/ คัดกรองสุขภาพจิต 2Q, 9Q, 8Q, 2Q+, RQ
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_3_2" class="flat-red" value="1">&nbsp; 
					  มีแบบประเมิน Mini cog
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_3_3" class="flat-red" value="1">&nbsp; 
					  แบบประเมินความเครียด (ST 5)
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_3_4" class="flat-red" value="1" >&nbsp; 
					  5 สัญญานเตือนการก่อความรุนแรง (SMI-V Scan)
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_3_5" class="flat-red" value="1" >&nbsp; 
					  แบบคัดกรองและส่งต่อผู้ป่วยที่ใช้ยาและสารเสพติดเพื่อรับการบำบัดรักษา (บคก.กสธ.) V.2
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_3_6" class="flat-red" value="1" >&nbsp; 
					  แบบคัดกรองสมรรถภาพสมอง (ภาวะสมองเสื่อม) (Abbreviated Mental Test: AMT)
					</span><br>
					<span>
					  <input type="checkbox" name="qus2_3_7" class="flat-red" value="1" >&nbsp; 
			...
			<div class="card card-outline card-warning">
				...
				<div class="card-body">
					<span>
					  <input type="checkbox" name="qus3_1_1" class="flat-red" value="1">&nbsp; มีระบบบริการติดตามดูแลผู้ป่วยจิตเวชต่อเนื่องในชุมชน (มีบริการเยี่ยมบ้าน ค้นหาครอบครัวเสี่ยงต่อการก่อความรุนแรง (SMI-V Scan), มีบริการเยี่ยมบ้านติดตามดูแลต่อเนื่องในผู้ป่วยจิตเวชและจิตเวชยาเสพติด (V Care) )
					</span><br>
					<span>
					  <input type="checkbox" name="qus3_1_2" class="flat-red" value="1">&nbsp; การจัดการรายกรณี (Case Management) (ประสานความร่วมมือกับทีมจัดการรายกรณี (CaseManagement Team) ร่วมกับหน่วยงานด้านสังคมและความมั่นคง เพื่อการดูแลผู้ป่วยจิตเวชยาเสพติดและผู้ป่วย SMI-V)
					</span><br>
					<span>
					...
					<span>
					  <input type="checkbox" name="qus3_1_6" class="flat-red" value="1">&nbsp; 
					  มีบริการปฐมพยาบาลทางใจในสถานการณ์วิกฤตได้
					</span><br>
					<span>
					  <input type="checkbox" name="qus3_1_7" class="flat-red" value="1">&nbsp; 
			...
			<div class="card card-outline card-success">
				...
				<div class="card-body">
					<span>
					  <input type="checkbox" name="qus4_1_1" class="flat-red" value="1">&nbsp; 
						มีบริการคัดกรองผู้ป่วยเด็กปฐมวัยพัฒนาการล้าช้า ด้วยเครื่องมือ DSPM และ DAIM
					</span><br>
					<span>
					  <input type="checkbox" name="qus4_1_2" class="flat-red" value="1">&nbsp; 
					  มีระบบส่งต่อผู้ป่วยเด็กปฐมวัยพัฒนาการล้าช้า
					</span><br>
					<span>
					  <input type="checkbox" name="qus4_1_3" class="flat-red" value="1">&nbsp; 
						ส่งเสริมพัฒนาการและทักษะการเลี้ยงดูในเด็กปฐมวัย
					</span><br>
					<span>
					  <input type="checkbox" name="qus4_1_4" class="flat-red" value="1">&nbsp; 
			...
			<div class="card card-outline card-success">
				...
				<div class="card-body">
					<span>
					  <input type="checkbox" name="qus4_2_1" class="flat-red" value="1">&nbsp; 
						แบบบันทึก การเฝ้าระวังและส่งเสริมพัฒนาการ เด็กปฐมวัย DSPM
					</span><br>
					<span>
					  <input type="checkbox" name="qus4_2_2" class="flat-red" value="1">&nbsp; 
						แบบคัดกรอง DAIM
					</span><br>
					<span>
					  <input type="checkbox" name="qus4_2_3" class="flat-red" value="1">&nbsp; 
					  แบบประเมินความฉลาดทางด้านอารมณ์เด็กปฐมวัย 3-5 ปี ฉบับพ่อแม่ ผู้ปกครอง
					</span><br>

					<span>
					  <input type="checkbox" name="qus4_2_4" class="flat-red" value="1">&nbsp; 
			...
			<div class="card card-outline card-warning">
				...
				<div class="card-body">
					<span>
					  <input type="checkbox" name="qus5_1_1" class="flat-red" value="1">&nbsp; 
					  Mental Health Check-in 
					</span><br>
					<span>
					  <input type="checkbox" name="qus5_1_2" class="flat-red" value="1">&nbsp; 
					  Application คุณหมอพอดี D-Mind
					</span><br>
					<span>
					  <input type="checkbox" name="qus5_1_3" class="flat-red" value="1">&nbsp; 
					...
					<div class="row">
						<div class="col-md-9">
							...
							<!--<div class="row" style="padding-bottom: 5px;">	
								  ...
								  <div class="col-md-3">
									  <input name="number_patients_5" type="number" class="form-control" id="number_patients_5" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  " required>
								  </div>
					...
					-->
							...
							*/ ?>
							<div class="row" style="padding-bottom: 5px;">	
								  ...
								  <div class="col-md-5">
									  <input name="number_patients_9" type="number" class="form-control" id="number_patients_9" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  " required>
								  </div>
								  <div class="col-md-2">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">	
								  ...
								  <div class="col-md-5">
									  <input name="number_patients_10" type="number" class="form-control" id="number_patients_10" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  " required>
								  </div>
								  <div class="col-md-2">คน</div>
							</div>
			...
			<!-- / card card-outline card-primary-->
		     ...
		     <div class="card card-outline card-dark">
				...
				<div class="card-body">
					<div class="col-md-6 form-group">
						<textarea name="DevelopmentPlan" rows="3" class="form-control" id="DevelopmentPlan" placeholder="ถ้ามี"></textarea>
					</div>
				</div>
				<!-- / card-body-->
			</div>
...
<?php /*
	...
	$sqlfcenter = "SELECT mhpsID, qustype, HospitalID, qus1_1, qus1_2, qus1_3, qus1_4, qus2_1, qus3_1, qus3_2, qus3_3,qus3_4, qus3_5, number_patients, problems_obstacles, feedback, DevelopmentPlan, statusfinal  
					FROM serviceform 
					WHERE HospitalID = '$HospitalID'
					AND serviceform.qustype = '3'; "; 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4> แบบฟอร์มบันทึกข้อมูลบริการสุขภาพจิตและจิตเวช</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#"> บริการสุขภาพจิตและจิตเวช</a></li>
					...
					<div class="row">
						<div class="col-md-9">
							<div class="row" style="padding-bottom: 5px;">				  
								  <div class="col-md-5"><i class='fas fa-caret-right' style='font-size:14px'></i>&nbsp;&nbsp;จำนวนผู้ป่วยจิตเวชทั้งหมด</div>
								  <div class="col-md-3">
									  <input name="number_patients_1" type="text" class="form-control" id="number_patients_1" value="<?php echo $number_patients[0]; ?>" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">	
								  <div class="col-md-5"><i class='fas fa-caret-right' style='font-size:14px'></i>&nbsp;&nbsp;จำนวนผู้ป่วยจิตเวช เยี่ยมบ้าน</div>
								  <div class="col-md-3">
									  <input name="number_patients_2" type="text" class="form-control" id="number_patients_2" value="<?php echo $number_patients[1]; ?>" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">	
								  ...
								  <div class="col-md-3">
									  <input name="number_patients_3" type="text" class="form-control" id="number_patients_3" value="<?php echo $number_patients[2]; ?>" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">	
								  ...
								  <div class="col-md-3">
									  <input name="number_patients_4" type="text" class="form-control" id="number_patients_4" value="<?php echo $number_patients[3]; ?>" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">	
								  <div class="col-md-5"><i class='fas fa-caret-right' style='font-size:14px'></i>&nbsp;&nbsp;จำนวนผู้ป่วยโรคจิต (F20-F29)</div>
								  <div class="col-md-3">
									  <input name="number_patients_5" type="text" class="form-control" id="number_patients_5" value="<?php echo $number_patients[4]; ?>" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">	
								  <div class="col-md-5"><i class='fas fa-caret-right' style='font-size:14px'></i>&nbsp;&nbsp;จำนวนผู้ป่วยซึมเศร้า (F32.0-F32.9, F33.0-F33.9, F34.1)</div>
								  <div class="col-md-3">
									  <input name="number_patients_6" type="text" class="form-control" id="number_patients_6" value="<?php echo $number_patients[5]; ?>" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">	
								  <div class="col-md-5"><i class='fas fa-caret-right' style='font-size:14px'></i>&nbsp;&nbsp;จำนวนผู้ป่วยสุราและสารเสพติด (F10-F19)</div>
								  <div class="col-md-3">
									  <input name="number_patients_7" type="text" class="form-control" id="number_patients_7" value="<?php echo $number_patients[6]; ?>" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">	
								  <div class="col-md-5"><i class='fas fa-caret-right' style='font-size:14px'></i>&nbsp;&nbsp;จำนวนผู้ป่วยเด็กออทิสติก (F84.0-F84.9)</div>
								  <div class="col-md-3">
									  <input name="number_patients_8" type="text" class="form-control" id="number_patients_8" value="<?php echo $number_patients[7]; ?>" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">	
								  <div class="col-md-5"><i class='fas fa-caret-right' style='font-size:14px'></i>&nbsp;&nbsp;จำนวนผู้ป่วยเด็กสมาธิสั้น (F90)</div>
								  <div class="col-md-3">
									  <input name="number_patients_9" type="text" class="form-control" id="number_patients_9" value="<?php echo $number_patients[8]; ?>" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">	
								  <div class="col-md-5"><i class='fas fa-caret-right' style='font-size:14px'></i>&nbsp;&nbsp;จำนวนเด็กได้รับบริการคัดกรองด้วยเครื่องมือ DSPM และ DAIM</div>
								  <div class="col-md-3">
									  <input name="number_patients_10" type="text" class="form-control" id="number_patients_10" value="<?php echo $number_patients[9]; ?>" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">	
								  <div class="col-md-5"><i class='fas fa-caret-right' style='font-size:14px'></i>&nbsp;&nbsp;จำนวนผู้ป่วยคลินิกกระตุ้นพัฒนาการ</div>
								  <div class="col-md-3">
									  <input name="number_patients_11" type="text" class="form-control" id="number_patients_11" value="<?php echo $number_patients[10]; ?>" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
