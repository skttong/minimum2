			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<select name="txtHospitalID" class="form-control select2" style="width: 100%;" required>
						...
						<?php
							$query = $con->query("SELECT * FROM hospitalnew WHERE hospitalnew.HOS_TYPE = 'โรงพยาบาลส่งเสริมสุขภาพตำบล' OR hospitalnew.HOS_TYPE = 'ศูนย์บริการสาธารณสุข อปท.' order by hospitalnew.CODE5 ") or die(mysqli_error());
      ...
      <div class="card card-info card-outline">
		  ...
		  <h5><i class='fas fa-edit'></i> 1. บริการจิตเวชฉุกเฉิน</h5>
		    ...
		    <div class="card card-outline card-dark">
				<div class="card-header">
					<h3 class="card-title">จำนวนผู้รับบริการ ปีงบประมาณ <?php echo $YEAR-1 ;?>
