...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      $TypeService = $_SESSION["TypeService"];
		...
		?>
		 ...
		 <?php if($TypeService <> ''){?>
          ...
          <?php }else{ ?>
			<h4>เพิ่มผู้ใช้งาน <br>  <?php echo $HOS_NAME ;?>  </h4>
         <?php } ?> 
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
		<form class="form-valide" action="admin_add_all.php" method="post" id="myform1" name="foml">
			<input type="hidden" name="txtHospitalID" value="<?php echo $HospitalID; ?>"> 
			  ...
			  <div class="card card-success card-outline">
				<div class="card-header">
				  <h3 class="card-title" style="color: dimgray"> เพิ่มผู้ใช้งาน</h3>
				...
				<div class="invalid-feedback" style="font-size: 100%">
                    ...
                    <div class="container">
                        ...
                        <div class="form-group col-6">
                            <div class="form-group">
                                ...
                                <input  type="text" name="username" class="form-control" id="username" placeholder="username" onkeyup="isThaichar(this.value,this)" required>
                            </div>
                        </div>
                        <div class="form-group col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="password" class="form-control" id="password" placeholder="password" onkeyup="isThaichar(this.value,this)" required>
                            </div>
                        </div>
                        </div>
                    </div>
                  ...
                  <select name="CODE_PROVINCE" class="form-control select2" id="CODE_PROVINCE" style="width: 100%;" onChange="myFunction4()" required>
                      ...
                      const selectedValue = $('#CODE_PROVINCE').val();
                        ...
                        <div class="form-group col-6">
                            <div class="form-group">
                                ...
                                <select name="CODE_HOS" class="form-control select2" id="CODE_HOS" style="width: 100%;" required>
                                    <option selected="selected" value="" >ทั้งหมด</option>
                                    <?PHP
