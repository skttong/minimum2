...
<?php /*
	...
	$sqlfcenter = "SELECT mhpsID, qustype, HospitalID, qus1_1, qus1_2, qus1_3, qus1_4, qus2_1, qus3_1, qus3_2, qus3_3, number_patients, problems_obstacles, feedback, DevelopmentPlan, statusfinal  
				   FROM serviceform 
...
<script type="text/javascript">/*
    window.onload=function(){
        var auto = setTimeout(function(){ autoRefresh(); }, 10000);
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <section class="content">
	<form method="post" enctype="multipart/form-data" name="form1" id="formupdate" action="ServiceForm_community_update.php">
		<input type="hidden" value="<?php echo $_SESSION['UserID']; ?>" name="txtUserID">
		<input type="hidden" value="<?php echo $HospitalID; ?>" name="txtHospitalID">  
		  ...
		  <div class="card-body">			  
			...
			<div class="card card-outline card-primary">
				...
				<div class="card-body">
					...
					<?php } ?>	
						...
						มีระบบปรึกษา (Consult) กับโรงพยาบาลแม่ข่าย
					</span><br>
					<span>
					<?php if($qus1_1[4] == '0'){ ?> 
					  <input name="qus1_1_5" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
			...
			<div class="card card-outline card-primary">
				...
				<div class="card-body">
					<span>
					<?php if($qus1_2[0] == '0'){ ?> 
					  <input name="qus1_2_1" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
					...
					<span>
					<?php if($qus1_2[1] == '0'){ ?> 
					  <input name="qus1_2_2" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
					...
					<span>
					<?php if($qus1_2[2] == '0'){ ?> 
					  <input name="qus1_2_3" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
					  <input name="qus1_2_3" type="checkbox" class="flat-red" value="1" checked="checked">&nbsp; 
					<?php } ?>		
			...
			<div class="card card-outline card-primary">
				...
				<div class="card-body">
					...
					<?php } ?>	
						...
						มีการให้การปรึกษาผู้ป่วยจิตเวชและญาติ
					</span><br>
					<span>
					<?php if($qus1_3[3] == '0'){ ?> 
					  <input name="qus1_3_4" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
					...
					<span>
					<?php if($qus1_3[4] == '0'){ ?> 
					  <input name="qus1_3_5" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
			...
			<div class="card card-outline card-primary">
				...
				<div class="card-body">
					<span>
					<?php if($qus1_4[0] == '0'){ ?> 
					  <input name="qus1_4_1" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
					...
					<span>
					<?php if($qus1_4[1] == '0'){ ?> 
					  <input name="qus1_4_2" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
					...
					<span>
					<?php if($qus1_4[2] == '0'){ ?> 
					  <input name="qus1_4_3" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
					...
					<span>
					<?php if($qus1_4[3] == '0'){ ?> 
					  <input name="qus1_4_4" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
			...
			<div class="card card-outline card-success">
				...
				<div class="card-body">
					...
					<?php }else{ ?>
					<span>
						  <input type="checkbox" name="qus3_1_2" class="flat-red" value="1" onclick="enablequs3_1();"  checked="checked">&nbsp; 
							มีบริการคัดกรอง และกระตุ้นพัฒนาการเด็กที่มีพัฒนาการล่าช้าโปรดระบุเครื่องมือที่ใช้
						</span><br>

						<p class="col-md-6" style="margin-top:7px;">
						  <span for="other_qus3_1_2">โปรดระบุเครื่องมือที่ใช้</span><b><span style="color:red;" >*</span></b>
						  <input name="other_qus3_1_2" type="text" class="form-control" id="other_qus3_1_2" value="<?php echo $qus3_1[2] ;?>" placeholder="โปรดระบุ" required>
						</p> 
					<?php } ?>  
			...
			<div class="card card-outline card-success">
				...
				<div class="card-body">
					<span>
					<?php if($qus3_2[0] == '0'){ ?> 
					  <input name="qus3_2_1" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
					...
					<span>
					<?php if($qus3_2[1] == '0'){ ?> 
					  <input name="qus3_2_2" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
					...
					<span>
					<?php if($qus3_2[2] == '0'){ ?> 
					  <input name="qus3_2_3" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
					...
					<span>
					<?php if($qus3_2[3] == '0'){ ?> 
					  <input name="qus3_2_4" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
					...
					<span>
					<?php if($qus3_2[4] == '0'){ ?> 
					  <input name="qus3_2_5" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
					...
					<span>
					<?php if($qus3_2[5] == '0'){ ?> 
					  <input name="qus3_2_6" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
					...
					<span>
					<?php if($qus3_2[6] == '0'){ ?> 
					  <input name="qus3_2_7" type="checkbox" class="flat-red" value="1">&nbsp; 
					<?php }else{ ?>
					...
					<?php }else{ ?>
					  ...
					  <input type="checkbox" name="qus3_2_8" class="flat-red" value="1" onclick="enablequs3_2();" checked="checked">&nbsp; 
						อื่น ๆ
					</span><br>

					<p class="col-md-6" style="margin-top:7px;">
					  <span for="other_qus3_2_8">โปรดระบุ</span><b><span style="color:red;">*</span></b>
					  <input name="other_qus3_2_8" type="text" class="form-control" id="other_qus3_2_8" value="<?PHP echo $qus3_2[8]; ?>" placeholder="โปรดระบุ" required>
					</p> 
					<?php } ?>  
					...
					<div class="row">
						<div class="col-md-9">
							<div class="row" style="padding-bottom: 5px;">				  
								<div class="col-md-5"><i class='fas fa-caret-right' style='font-size:14px'></i> จำนวนผู้ป่วยจิตเวชทั้งหมด</div>
								  <div class="col-md-3">
									  <input name="number_patients_1" type="text" class="form-control" id="number_patients_1" value="<?php echo $number_patients[0]; ?>" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)  ถ้าไม่มีใหีใส่ 0 " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">	
							...
							<div class="row" style="padding-bottom: 5px;">							  
								  <div class="col-md-5">จำนวนผู้ป่วยโรคจิต (F20-F29)</div>
								  <div class="col-md-3">
									  <input name="number_patients_12" type="text" class="form-control" id="number_patients_12" value="<?php //echo $number_patients[11]; ?>"  placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0) ถ้าไม่มีใหีใส่ 0 " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">							  
								  <div class="col-md-5">จำนวนผู้ป่วยซึมเศร้า (F32.0-F32.9, F33.0-F33.9, F34.1)</div>
								  <div class="col-md-3">
									  <input name="number_patients_13" type="text" class="form-control" id="number_patients_13" value="<?php //echo $number_patients[12]; ?>"  placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0) ถ้าไม่มีใหีใส่ 0 " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">						  
								  <div class="col-md-5">จำนวนผู้ป่วยโรคสุราและสารเสพติด (F10-F19)</div>
								  <div class="col-md-3">
									  <input name="number_patients_14" type="text" class="form-control" id="number_patients_14" value="<?php //echo $number_patients[13]; ?>"  placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0) ถ้าไม่มีใหีใส่ 0 " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">						  
								  <div class="col-md-5">จำนวนผู้ป่วยโรคสมาธิสั้น (F90)</div>
								  <div class="col-md-3">
									  <input name="number_patients_15" type="text" class="form-control" id="number_patients_15" value="<?php //echo $number_patients[14]; ?>"  placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0) ถ้าไม่มีใหีใส่ 0 " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">						  
								  <div class="col-md-5">จำนวนผู้ป่วยโรคออทิสติก (F84.0-F84.9)</div>
								  <div class="col-md-3">
									  <input name="number_patients_16" type="text" class="form-control" id="number_patients_16" value="<?php //echo $number_patients[15]; ?>"  placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0) ถ้าไม่มีใหีใส่ 0 " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							<div class="row" style="padding-bottom: 5px;">						  
								  ...
								  <div class="col-md-3">
									  <input name="number_patients_17" type="text" class="form-control" id="number_patients_17" value="<?php //echo $number_patients[16]; ?>"  placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0) ถ้าไม่มีใหีใส่ 0 " required>
								  </div>
								  <div class="col-md-3">คน</div>
							</div>
							-->
