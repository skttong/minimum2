...
$sql18 = "SELECT personnel.positiontypeID, Count(personnel.personnelID) AS Count_perstype FROM personnel WHERE personnel.positiontypeID = '3';";
$obj18 = mysqli_query($con, $sql18);
$row18 = mysqli_fetch_array($obj18);

$sql19 = "SELECT personnel.positiontypeID, Count(personnel.personnelID) AS Count_perstype FROM personnel WHERE personnel.positiontypeID = '5';";
$obj19 = mysqli_query($con, $sql19);
$row19 = mysqli_fetch_array($obj19);

$sql20 = "SELECT personnel.positiontypeID, Count(personnel.personnelID) AS Count_perstype FROM personnel WHERE personnel.positiontypeID = '6';";
$obj20 = mysqli_query($con, $sql20);
$row20 = mysqli_fetch_array($obj20);

$sql21 = "SELECT personnel.positiontypeID, Count(personnel.personnelID) AS Count_perstype FROM personnel WHERE personnel.positiontypeID = '7';";
...
$sqlect = "SELECT ect.ect, sum(ect.ect_no) AS S_ECT  FROM ect WHERE ect.ect = 'มี';";
$object = mysqli_query($con, $sqlect);
$rowect = mysqli_fetch_array($object);

$sqltms = "SELECT ect.tms, Sum(ect.tms_no ) AS S_TMS FROM ect WHERE ect.tms = 'มี'";
$objtms = mysqli_query($con, $sqltms);
$rowtms = mysqli_fetch_array($objtms);

$sqlbedw = "SELECT bed.Wardall, SUM(bed.Ward_no) AS SWard FROM bed WHERE bed.Wardall = 'มี'";
$objbedw = mysqli_query($con, $sqlbedw);
$rowbedw = mysqli_fetch_array($objbedw);
$bedw = $rowbedw['SWard'];

$sqlbedp = "SELECT bed.Unit, Sum(bed.Unit_no) AS SUNIT FROM bed WHERE bed.Unit = 'มี'";
$objbedp = mysqli_query($con, $sqlbedp);
$rowbedp = mysqli_fetch_array($objbedp);
$bedu = $rowbedp['SUNIT'];

$sqlbedi = "SELECT bed.Integrate, Sum(bed.Integrate_no) AS SIN FROM bed WHERE bed.Integrate = 'มี'";
