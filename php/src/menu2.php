      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		 ...
		 <li class="nav-item">
			...
			<li class="nav-item">
				<!--<a href="report-1.php" class="nav-link">-->
				<a href="dashboard04.php" class="nav-link">
				<i class="fas fa-minus nav-icon" style="font-size:12px;"></i>
				<p>
			...
			<li class="nav-item">
				<!--<a href="report-1.php" class="nav-link">-->
				<a href="dashboard05.php" class="nav-link">
				<i class="fas fa-minus nav-icon" style="font-size:12px;"></i>
				<p>
			...
			<li class="nav-item">
				<!--<a href="report-1.php" class="nav-link">-->
				<a href="dashboard06.php" class="nav-link">
				<i class="fas fa-minus nav-icon" style="font-size:12px;"></i>
				<p>
				ระบบบริการจิตเวช
					<!--<i class="right fas fa-angle-left"></i>-->
		 ...
		 <li class="nav-item">
            <!--<a href="report-1.php" class="nav-link">-->
			<a href="dashboard07.php" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
			  ข้อมูลทรัพยากร MCATT
                <!--<i class="right fas fa-angle-left"></i>-->
             </p>
            </a>
			<ul class="nav nav-treeview">
			...
			<li class="nav-item">
				<!--<a href="report-1.php" class="nav-link">-->
				<a href="dashboard08doctor.php" class="nav-link">
				<i class="fas fa-minus nav-icon" style="font-size:12px;"></i>
				<p>
				ข้อมูลทรัพยากร
					<!--<i class="right fas fa-angle-left"></i>-->
		 ...
		 <li class="nav-item">
				<!--<a href="report-1.php" class="nav-link">-->
				<a href="dashboard09.php" class="nav-link">
				<i class="nav-icon fas fa-tachometer-alt"></i>
				<p>
				ข้อมูลการบริการจิตเวชและยาเสพติด
					<!--<i class="right fas fa-angle-left"></i>-->
				</p>
				</a>
				<ul class="nav nav-treeview">
			...
			<li class="nav-item">
				<!--<a href="report-1.php" class="nav-link">-->
				<a href="dashboard10.php" class="nav-link">
				<i class="fas fa-minus nav-icon" style="font-size:12px;"></i>
				<p>
