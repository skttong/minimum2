...
if (isset($data)) {
  ...
  $sql = "DELETE FROM HDCTB06 WHERE b_year = ".$YEAR;
  ...
  $stmt = mysqli_prepare($con, "INSERT INTO HDCTB06(id, hospcode, areacode, date_com, b_year, smiv, total, f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, other, x60_x84) 
    VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
