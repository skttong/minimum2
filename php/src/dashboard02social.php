...
$sql1 = "SELECT
    SUM(CASE WHEN p.positiontypeID = '5' THEN 1 ELSE 0 END) AS TC01
FROM
    personnel p
...
$dHMOO1 = "'เขตสุขภาพที่ 1', 'เขตสุขภาพที่ 2', 'เขตสุขภาพที่ 3', 'เขตสุขภาพที่ 4', 'เขตสุขภาพที่ 5', 'เขตสุขภาพที่ 6', 'เขตสุขภาพที่ 7', 'เขตสุขภาพที่ 8', 'เขตสุขภาพที่ 9', 'เขตสุขภาพที่ 10', 'เขตสุขภาพที่ 11', 'เขตสุขภาพที่ 12', 'เขตสุขภาพที่ 13'";
 ...
 $sqlall = "SELECT hn.HOS_NAME,COUNT(*) AS 'total' 
          ...
          WHERE p.positiontypeID = '5' AND p.setdel = '1' 
          ";
   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              <h3>ข้อมูลทรัพยากรบุคลากร นักสังคมสงเคราะห์ </h3>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
			<form class="form-valide" action="dashboard02social.php" method="post" id="myform1" name="foml">  
      <div class="row">
      <div class="col-md-2">
			...
			<div class="card">
				...
				<table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr align="center">
					  ...
					  <th width="15%">นักสังคมสงเคราะห์</th>
				   </tr>
                   </thead>
                  <tbody>
                  <?php
