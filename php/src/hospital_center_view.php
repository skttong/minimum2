      ...
      <div class="card card-info card-outline">
		  ...
		  <div class="card-body">			  
		    ...
		    <div class="card card-outline card-dark">
				<div class="card-header">
					<h3 class="card-title">จำนวนผู้รับบริการ ปีงบประมาณ <?php echo date("Y")+543-1 ;?></h3><br>
			...
			<div class="text-muted mt-3">
			  <div class="row">
				  <div class="col-md-6">
					  ...
					  <a href="hospital_center_view_print.php?FID=<?php echo $FID ;?>" class="btn btn-default" target="_blank" > PDF &nbsp;</a>
