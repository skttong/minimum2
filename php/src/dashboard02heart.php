...
if (isset($_POST['Affiliation'])) {
  ...
  $sql1 = $sql1."AND h.Affiliation = '".$Affiliation."'" ;
  }
}
...
if (isset($_POST['CODE_HMOO'])) {
  if ($_POST['CODE_HMOO']<> 'ทั้งหมด') {
  $CODE_HMOO = $_POST['CODE_HMOO'];
  $sql2 = $sql2."AND h.CODE_HMOO = '".$CODE_HMOO."'" ;
  }
}
...
if (isset($_POST['type_Affiliation'])) {
  if (trim($_POST['type_Affiliation'])<> 'ทั้งหมด') {
  $type_Affiliation = trim($_POST['type_Affiliation']);
  $sql2 = $sql2."AND h.type_Affiliation LIKE ('".$type_Affiliation."%')" ;
  }
}
...
if (isset($_POST['Affiliation'])) {
  if (trim($_POST['Affiliation'])<> 'ทั้งหมด') {
  $Affiliation = trim($_POST['Affiliation']);
  $sql2 = $sql2."AND h.Affiliation = '".$Affiliation."'" ;
  }
}
...
if (isset($_POST['TYPE_SERVICE'])) {
  if (trim($_POST['TYPE_SERVICE'])<> 'ทั้งหมด') {
  $mySelect = trim($_POST['TYPE_SERVICE']);
  $sql2 = $sql2."AND h.HOS_TYPE = '".$mySelect."'" ;
  }
}
...
if (isset($_POST['CODE_PROVINCE'])) {
	if ($_POST['CODE_PROVINCE']<> 'ทั้งหมด') {
	$CODE_PROVINCE = $_POST['CODE_PROVINCE'];
	$sql2 = $sql2."AND h.NO_PROVINCE = '".$CODE_PROVINCE."'" ;
	}
  }
   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h3>ข้อมูลทรัพยากรบุคลากร นักจิตวิทยา </h3>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
			<form class="form-valide" action="dashboard02heart.php" method="post" id="myform1" name="foml">  
      <div class="row">
      <div class="col-md-2">
    ...
    link.click();
		...
		<div class="row">
			<div class="col-lg-6">
				...
				<p><?php echo number_format((($TC01 / $Total)*100000), 4, '.', ',');?>  : 1แสน ประชากร</p>
			  ...
			  <div class="col-lg-6">
                ...
                <div class="inner">
                    ...
                    <p><?php echo number_format((($TC02 / $Total)*100000), 4, '.', ',');?>  : 1แสน ประชากร</p>
...
<script>
        ...
        document.getElementById('resetButton').addEventListener('click', function() {
           ...
           window.location.href = 'dashboard02heart.php'; 
        });
