		...
		<div class="row" style="padding-bottom: 10px;"> 
		  <div class="col-md-8">
			  <div class="form-group">
				...
				<p></p>-->
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="training_1" name="training" value="ด้านสุขภาพจิตและจิตเวช" onclick="disableTxt2();" required
				...
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="training_2" name="training" value="ด้านยาเสพติด" onclick="disableTxt2();"required
                    <?php if($row1['training'] == "ด้านยาเสพติด"){echo 'checked';} ?>>
					<label class="custom-control-label" for="training_2"></label>ด้านยาเสพติด
			    </div>
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="training_3" name="training" value="อื่น ๆ" onclick="enableTxt2();" required
				...
				<script>
					function disableTxt2() {
					  ...
					  document.getElementById("other_training2").value = "";	
					}
					function enableTxt2() {
		  ...
		  <div class="col-md-8">
			  <div class="form-group">
				...
				<div class="col-6" style="margin-top: 10px;">
                  ...
                  <?php if($row1['training'] == "อื่น ๆ"){?>
                    <input name="other2_training" type="text" class="form-control" id="other2_training" placeholder="โปรดระบุ" value="<?php echo $row1['other_training']; ?>"  required>
				  <?php }else{?>
                    <input name="other2_training" type="text" class="form-control" id="other2_training" placeholder="โปรดระบุ" disabled required>
				  <?php }?>
                </div>
