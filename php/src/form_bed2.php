  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>แบบฟอร์มบันทึกข้อมูลเตียงจิตเวช</h4>
          </div>
          <div class="col-sm-6">
		  ...
		  <div class="col-md-8">
			  <div class="form-group">
			   ...
			   <!-- <span style="color: darkblue"><b>(ตอบได้มากกว่า 1 ข้อ)</b></span>
				  ...
				  <div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="training_1_1" name="training_1" value="Psychiatric Ward">
				...
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="training_1_2" name="training_1" value="Psychiatric Unit/ Co-Ward">
				...
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="training_1_3" name="training_1" value="Integrated Bed ">
				...
				<div class="custom-control custom-radio ">
					<input type="radio" class="custom-control-input" id="training_1_4" name="training_1" value="ไม่มี">
			...
			<div class="custom-control custom-checkbox">
				...
				<div class="row" style="padding-bottom: 5px;">	
						<div class="col-md-5">&nbsp;&nbsp;จำนวนเตียงจิตเวช <span class="disabledspan">(A)</span>
						</div>
						<div class="col-md-3">
							<input name="number_patients_17" type="number" class="form-control" id="number_patients_17"  onchange="calculateTotal2()" placeholder="กรอกจำนวน (เฉพาะตัวเลขเท่านั้น)  ถ้าไม่มีให้ใส่ 0 " required>
						</div>
				...
				<div class="row" style="padding-bottom: 5px;">	
						...
						<div class="col-md-3">
							<input name="number_patients_18" type="number" class="form-control" id="number_patients_18" placeholder="กรอกจำนวน (เฉพาะตัวเลขเท่านั้น)  ถ้าไม่มีให้ใส่ 0 " required>
						</div>
						<div class="col-md-3">เตียง</div>
				</div>
				<div class="row" style="padding-bottom: 5px;">	
						...
						<div class="col-md-3">
							<input name="number_patients_19" type="number" class="form-control" id="number_patients_19"  placeholder="กรอกจำนวน (เฉพาะตัวเลขเท่านั้น)  ถ้าไม่มีให้ใส่ 0 " required>
						</div>
						<div class="col-md-3">เตียง</div>
				</div>
				<div class="row" style="padding-bottom: 5px;">	
...
OTHER, External Cause : X60-X84</span>
						...
						<div class="col-md-3">
							<input name="number_patients_20" type="number" class="form-control" id="number_patients_20" onchange="calculateTotal2()" placeholder="กรอกจำนวน (เฉพาะตัวเลขเท่านั้น)  ถ้าไม่มีให้ใส่ 0 " required>
						</div>
						<div class="col-md-3">ราย <span class="disabledspan">(B)</span></div>
				</div>
				<div class="row" style="padding-bottom: 5px;">	
...
สูตรการคำนวณวันนอน = (DATETIME_DISCH - DATETIME_ADMIT) หากได้ 0 ให้บวก 1</span>
						...
						<div class="col-md-3">
							<input name="number_patients_21" type="number" class="form-control" id="number_patients_21" onchange="calculateTotal2()" placeholder="กรอกจำนวน (เฉพาะตัวเลขเท่านั้น)  ถ้าไม่มีให้ใส่ 0 " required>
						</div>
						<div class="col-md-3">วัน <span class="disabledspan">(C)</span></div>
				</div>
				<div class="row" style="padding-bottom: 5px;">	
...
และยาเสพติดจำหน่ายทั้งหมด</span>
						...
						<div class="col-md-3">
							<input name="number_patients_22" type="text" class="form-control" id="number_patients_22" placeholder="กรอกจำนวน (เฉพาะตัวเลขเท่านั้น)  ถ้าไม่มีให้ใส่ 0 " readonly>
						</div>
				...
				<div class="row" style="padding-bottom: 5px;">	
						...
						<div class="col-md-3">
							<input name="number_patients_23" type="number" class="form-control" id="number_patients_23" placeholder="กรอกจำนวน (เฉพาะตัวเลขเท่านั้น)  ถ้าไม่มีให้ใส่ 0 " readonly>
						</div>
...
และยาเสพติดจำหน่ายทั้งหมด</span>
						...
						<div class="col-md-3">
							<input name="number_patients_22" type="text" class="form-control" id="number_patients_22" placeholder="กรอกจำนวน (เฉพาะตัวเลขเท่านั้น)  ถ้าไม่มีให้ใส่ 0 " required>
						</div>
						<div class="col-md-3">วัน</div>
				</div>
				<div class="row" style="padding-bottom: 5px;">	
						...
						<div class="col-md-3">
							<input name="number_patients_23" type="number" class="form-control" id="number_patients_23" placeholder="กรอกจำนวน (เฉพาะตัวเลขเท่านั้น)  ถ้าไม่มีให้ใส่ 0 " required>
						</div>
						<div class="col-md-3">% <div class="tooltip2"><i class='far fa-question-circle' style='font-size:14px;color:royalblue;'></i>
						<span class="tooltiptext">คำนวณให้อัตโนมัติโดยใช้ สูตร B*100/A*จำนวนวันตั้งแต่ตุลาคม ปีงบประมาณปัจจุบัน
จนถึงวันที่ลงข้อมูล</span>
