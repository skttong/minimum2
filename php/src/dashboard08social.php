...
$sql1 = "SELECT
    SUM(CASE WHEN personnel.positiontypeID = '5' THEN 1 ELSE 0 END) AS TC01
FROM
    personnel
...
$sql2 = "SELECT
  SUM(CASE WHEN hn.HOS_TYPE in ('กรมสุขภาพจิต','ศูนย์วิชาการ')AND p.positiontypeID = '5' THEN 1 ELSE 0 END) AS 'MA01',
  SUM(CASE WHEN hn.HOS_TYPE in ('โรงพยาบาลศูนย์','โรงพยาบาลทั่วไป' ,'สำนักงานสาธารณสุขจังหวัด') AND p.positiontypeID = '5' THEN 1 ELSE 0 END) AS 'MA02',
  SUM(CASE WHEN hn.HOS_TYPE in ('โรงพยาบาลชุมชน','สำนักงานสาธารณสุขอำเภอ') AND p.positiontypeID = '5' THEN 1 ELSE 0 END) AS 'MA03',
  SUM(CASE WHEN hn.HOS_TYPE in ('โรงพยาบาลส่งเสริมสุขภาพตำบล','ศูนย์บริการสาธารณสุข อปท.') AND p.positiontypeID = '5' THEN 1 ELSE 0 END) AS 'MA04'
FROM
  hospitalnew hn 
...
$MOOsql1 = "SELECT
  hn.CODE_HMOO,
  SUM(CASE WHEN p.positiontypeID = '5' THEN 1 ELSE 0 END) AS 'PA01_1'
FROM
  hospitalnew hn 
LEFT JOIN personnel p ON hn.CODE5 = p.HospitalID
WHERE
...
SELECT
  hg.CODE_PROVINCE,
  hg.HospitalGroup,
  COUNT(CASE WHEN pt.positiontypeID = '5' THEN 1 END) AS MD01
FROM
  HospitalGroups hg
...
*/
  ...
  if (isset($_POST['CODE_PROVINCE'])) {
    if ($_POST['CODE_PROVINCE']<> 'ทั้งหมด') {
    $CODE_PROVINCE = $_POST['CODE_PROVINCE'];
    $MOOsql1 = $MOOsql1."AND hg.NO_PROVINCE = '".$CODE_PROVINCE."'" ;
    }
    }
    ...
    if ($_POST['CODE_HOS']<> 'ทั้งหมด') {
    $CODE_HOS = $_POST['CODE_HOS'];
    $MOOsql1 = $MOOsql1."AND hg.HospitalID = '".$CODE_HOS."'" ;
    }
    } 
   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h3> ข้อมูลทรัพยากร MCATT นักสังคมสงเคราะห์</h3>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
			<form class="form-valide" action="dashboard08social.php" method="post" id="myform1" name="foml">  
      <div class="row">
      <div class="col-md-2">
               <div class="form-group">
                  ...
                  <select name="position" class="form-control select2" id="position" style="width: 100%;">
                    ...
                    <option selected="selected" value="นักสังคมสงเคราะห์" >นักสังคมสงเคราะห์</option>
    ...
    <div class="col-md-12 col-sm-12 col-12">
	  <div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">นักสังคมสงเคราะห์ปฏิบัติงานวิกฤตสุขภาพจิต (MCATT) จำแนกตามระดับ﻿</h3>
				</div>
      ...
      <div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">นักสังคมสงเคราะห์ปฏิบัติงานวิกฤตสุขภาพจิต (MCATT) รายเขตสุขภาพ﻿</h3>
          <div align="right">
...
<script>
        ...
        document.getElementById('resetButton').addEventListener('click', function() {
           ...
           window.location.href = 'dashboard08social.php'; 
        });
