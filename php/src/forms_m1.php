		  ...
		  <div class="col-md-4">
			  <div class="form-group">
				 ...
				 <select name="p_birthday" class="form-control select2" style="width: 100%;" onChange="calAge(this);" required>
					  ...
					  <?PHP for($i=0; $i<= ((date("Y")+523)-2500); $i++) {?>
...
*ตัวเลือก*</label>-->
				...
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="r1-1" name="r1" value="แพทย์เวชศาสตร์ป้องกันสุขภาพจิตชุมชน (อว. หรือ วว.)" onclick="disableTxt2(false);" required>
					<label class="custom-control-label" for="r1-1"></label>แพทย์เวชศาสตร์ป้องกันสุขภาพจิตชุมชน (อว. หรือ วว.)
			    </div>
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="r1-2" name="r1" value="จิตแพทย์ทั่วไป" onclick="disableTxt2(false);" required>
					<label class="custom-control-label" for="r1-2"></label>จิตแพทย์ทั่วไป
			    </div>
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="r1-3" name="r1" value="จิตแพทย์เด็กและวัยรุ่น"  onclick="disableTxt2(false);" required>
					<label class="custom-control-label" for="r1-3"></label>จิตแพทย์เด็กและวัยรุ่น
			    </div>
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="r1-4" name="r1" value="แพทย์สาขาอื่น ที่ปฏิบัติงานด้านจิตเวชผู้ใหญ่และจิตเวชเด็กและวัยรุ่น" onclick="enableTxt2();" required>
				...
				<br>
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="r1-5" name="r1" value="กำลังศึกษา" onclick="disableTxt2(true);" required>
		  ...
		  <div class="col-md-8">
			  <div class="form-group">
				...
				<div class="col-6" style="margin-top: 10px;">
                  ...
                  <input name="other_training" type="text" class="form-control" id="other_training" placeholder="โปรดระบุ" disabled >
                </div> 
				<script>
