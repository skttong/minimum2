...
<div class="wrapper">
  <div id="formContentRegis">
   ...
   <!-- <h2 class="inactive underlineHover">Sign Up </h2>-->
	...
	<form action="updateuserfirstlogin[test].php" method="post" class="needs-validation" name="formregister" novalidate >
	 <div class="container">
	 	<div class="row">
		  <div class="form-group col-6">
			  <div class="form-group">
                  ...
                  <select name="prename" class="select2" style="width: 85%;" required>
                  <option selected="selected" value="0">-- เลือกคำนำหน้าชื่อ --</option>
					<?php
	 	...
	 	<div class="row" style="margin-bottom: 10px;">
		  ...
		  <div class="form-group col-6">
			  <div class="form-group">
                  ...
                  <input  type="text" name="HospitalID" class="form-control" id="HospitalID" value="<?php echo $_SESSION["HOS_NAME"];?>" readonly>
              </div>
		  </div>
		</div>
	  </div>
