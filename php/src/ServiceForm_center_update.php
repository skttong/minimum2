...
if($_POST['qus1_1_8'] <> ''){
	$qus1_1 = $qus1_1.','.$_POST['qus1_1_8'];
}else{
	$qus1_1 = $qus1_1.','.'0';
}
if($_POST['qus1_1_9'] <> ''){
	$qus1_1 = $qus1_1.','.$_POST['qus1_1_9'];
}else{
	$qus1_1 = $qus1_1.','.'0';
}
if($_POST['qus1_1_10'] <> ''){
	$qus1_1 = $qus1_1.','.$_POST['qus1_1_10'];
}else{
	$qus1_1 = $qus1_1.','.'0';
}
...
if($_POST['qus1_4_5'] <> ''){
	$qus1_4 = $_POST['qus1_4_5'];
}else{
	$qus1_4 = '0';
}
if($_POST['qus1_4_1'] <> ''){
	$qus1_4 = $qus1_4.','.$_POST['qus1_4_1'];
}else{
	$qus1_4 = $qus1_4.','.'0';
}
if($_POST['qus1_4_2'] <> ''){
...
if($_POST['qus1_4_4'] <> ''){
	...
	if($_POST['other_qus1_4_4'] <> ''){
		$qus1_4 = $qus1_4.','.$_POST['other_qus1_4_4'];
	}
}else{
	$qus1_4 = $qus1_4.','.'0';
}
...
if($_POST['qus3_1_6'] <> ''){
	...
	if($_POST['other_qus3_1_6'] <> ''){
		$qus3_1 = $qus3_1.','.$_POST['other_qus3_1_6'];
	}
}else{
	$qus3_1 = $qus3_1.','.'0';
}
...
*/
if($_POST['qus3_3_1'] <> ''){
	$qus3_3 = $_POST['qus3_3_1'];
}else{
	$qus3_3 = '0';
}
if($_POST['qus3_3_2'] <> ''){
	$qus3_3 = $qus3_3.','.$_POST['qus3_3_2'];
}else{
	$qus3_3 = $qus3_3.','.'0';
}
if($_POST['qus3_3_3'] <> ''){
	$qus3_3 = $qus3_3.','.$_POST['qus3_3_3'];
}else{
	$qus3_3 = $qus3_3.','.'0';
}
if($_POST['qus3_3_4'] <> ''){
	$qus3_3 = $qus3_3.','.$_POST['qus3_3_4'];
}else{
	$qus3_3 = $qus3_3.','.'0';
}
if($_POST['qus3_3_5'] <> ''){
	$qus3_3 = $qus3_3.','.$_POST['qus3_3_5'];
}else{
	$qus3_3 = $qus3_3.','.'0';
}
/*
if($_POST['qus3_3_6'] <> ''){
	$qus3_3 = $qus3_3.','.$_POST['qus3_3_6'];
}else{
	$qus3_3 = $qus3_3.','.'0';
}
if($_POST['qus3_3_7'] <> ''){
	$qus3_3 = $qus3_3.','.$_POST['qus3_3_7'];
}else{
	$qus3_3 = $qus3_3.','.'0';
}
if($_POST['qus3_3_8'] <> ''){
	$qus3_3 = $qus3_3.','.$_POST['qus3_3_8'];
}else{
	$qus3_3 = $qus3_3.','.'0';
}
if($_POST['qus3_3_9'] <> ''){
	$qus3_3 = $qus3_3.','.$_POST['qus3_3_9'];
	if($_POST['other_qus3_3_9'] <> ''){
		$qus3_3 = $qus3_3.','.$_POST['other_qus3_3_9'];
	}
}else{
	$qus3_3 = $qus3_3.','.'0';
}
...
if($_POST['qus3_4_1'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_1'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_2'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_2'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_3'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_3'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_4'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_4'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_5'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_5'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_6'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_6'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_7'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_7'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_8'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_8'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_9'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_9'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_10'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_10'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_11'] <> ''){
	$qus3_3 = $qus3_4.','.$_POST['qus3_4_11'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_12'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_12'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_13'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_13'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_14'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_14'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_15'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_15'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_16'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_16'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
if($_POST['qus3_4_17'] <> ''){
	$qus3_4 = $qus3_4.','.$_POST['qus3_4_17'];
}else{
	$qus3_4 = $qus3_4.','.'0';
}
...
//$sql = "INSERT INTO serviceform(qustype, HospitalID, qus1_1, qus1_2, qus1_3, qus1_4, qus2_1, qus3_1, qus3_2, qus3_3, number_patients, problems_obstacles, feedback, DevelopmentPlan, statusfinal, UserID, mhpsDate) VALUES ('$qustype', '$HospitalID', '$qus1_1', '$qus1_2', '$qus1_3', '$qus1_4', '$qus2_1', '$qus3_1', '$qus3_2', '$qus3_3', '$number_patients', '$problems_obstacles', '$feedback', '$DevelopmentPlan', '0','$UserID', Now());";



//$sql = "UPDATE serviceform SET qus1_1='$qus1_1',qus1_2='$qus1_2',qus1_3='$qus1_3',qus1_4='$qus1_4',qus2_1='$qus2_1',qus3_1='$qus3_1',qus3_2='$qus3_2',qus3_3='$qus3_3',number_patients= '$number_patients',problems_obstacles='$problems_obstacles' ,feedback= '$feedback',DevelopmentPlan= '$DevelopmentPlan',statusfinal='$statusfinal',UserID='$UserID',mhpsDate= Now() WHERE mhpsID = '$mhpsID'";
