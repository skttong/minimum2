...
$sql1 = "SELECT
    SUM(CASE WHEN p.positiontypeID = '7' THEN 1 ELSE 0 END) AS TC01
FROM
    personnel p
...
$dHMOO1 = "'เขตสุขภาพที่ 1', 'เขตสุขภาพที่ 2', 'เขตสุขภาพที่ 3', 'เขตสุขภาพที่ 4', 'เขตสุขภาพที่ 5', 'เขตสุขภาพที่ 6', 'เขตสุขภาพที่ 7', 'เขตสุขภาพที่ 8', 'เขตสุขภาพที่ 9', 'เขตสุขภาพที่ 10', 'เขตสุขภาพที่ 11', 'เขตสุขภาพที่ 12', 'เขตสุขภาพที่ 13'";
 ...
 $sqlall = "SELECT hn.HOS_NAME,COUNT(*) AS 'total' 
          ...
          WHERE p.positiontypeID = '7' AND p.setdel = '1' 
   ";
   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              <h3>ข้อมูลทรัพยากรบุคลากร เวชศาสตร์สื่อความหมาย </h3>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
			<form class="form-valide" action="dashboard02translation.php" method="post" id="myform1" name="foml">  
      <div class="row">
              <div class="col-md-2">
                   ...
                   function myFunction2() {
                      ...
                      const codeprovince 		= document.getElementById("CODE_PROVINCE").value;
                          ...
                          $.ajax({
                            ...
                            data: { service_id: selectedValue , codeprovince: codeprovince, Affiliation: Affiliation},
                            success: function(data) {
                              $('#CODE_HOS').html(data);
                            }
                          });
...
ORDER BY hospitalnew.CODE_HMOO DESC;";
      ...
      <div class="row">
		<div class="col-md-6">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">เวชศาสตร์สื่อความหมาย</h3>
					<div align="right">
			...
			<div class="card">
				...
				<table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr align="center">
					  ...
					  <th width="15%">เวชศาสตร์สื่อความหมาย</th>
				   </tr>
                   </thead>
                  <tbody>
                  <?php
...
<script>
        ...
        document.getElementById('resetButton').addEventListener('click', function() {
           ...
           window.location.href = 'dashboard02translation.php'; 
        });
