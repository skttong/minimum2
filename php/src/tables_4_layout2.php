    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
			<form class="form-valide" action="tables_4_layout2.php" method="post" id="myform1" name="foml">  
            <div class="row">
              <div class="col-md-2">
              ...
              <div class="col-md-2">
               <div class="form-group">
                  ...
                  <select class="form-control select2" id='position' name='position' style="width: 100%;">
                    ...
                    <option value="4">นักจิตวิทยาคลินิก/นักจิตวิทยา</option>
