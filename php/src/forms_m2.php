		  ...
		  <div class="col-md-8">
			  <div class="form-group">
				...
				<div class="custom-control custom-radio">
					...
					<input name="other_congrat" type="hidden" class="form-control" id="other_congrat" placeholder="โปรดระบุ"  style="width: 50%" disabled required>
			  ...
			  <div class="form-group">
			    ...
			    <span style="color: darkblue"><b>(ตอบได้มากกว่า 1 ข้อ)</b></span>
				  ...
				  <div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="training_1" name="training_1" value="ยังไม่ผ่านการอบรมเฉพาะทาง" onclick="checkCheckbox2();" checked>
