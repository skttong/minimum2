...
$sql2 = "SELECT
  SUM(CASE WHEN hn.HOS_TYPE in ('กรมสุขภาพจิต')AND p.positiontypeID = '4' THEN 1 ELSE 0 END) AS 'MA01',
  SUM(CASE WHEN hn.HOS_TYPE in ('โรงพยาบาลศูนย์','โรงพยาบาลทั่วไป')AND p.positiontypeID = '4' THEN 1 ELSE 0 END) AS 'MA02',
  SUM(CASE WHEN hn.HOS_TYPE in ('โรงพยาบาลชุมชน') AND p.positiontypeID = '4' THEN 1 ELSE 0 END) AS 'MA03',
  SUM(CASE WHEN hn.HOS_TYPE in ('โรงพยาบาลส่งเสริมสุขภาพตำบล','ศูนย์บริการสาธารณสุข อปท.') AND p.positiontypeID = '4' THEN 1 ELSE 0 END) AS 'MA04'
FROM
  hospitalnew hn 
...
$sql3 = "SELECT
  SUM(CASE WHEN hn.HOS_TYPE in ('กรมสุขภาพจิต')AND p.positionrole = 'นักจิตวิทยา'AND p.positiontypeID = '4' THEN 1 ELSE 0 END) AS 'PA01_1',
  SUM(CASE WHEN hn.HOS_TYPE in ('โรงพยาบาลศูนย์','โรงพยาบาลทั่วไป')AND p.positionrole = 'นักจิตวิทยา'AND p.positiontypeID = '4' THEN 1 ELSE 0 END) AS 'PA02_1',
  SUM(CASE WHEN hn.HOS_TYPE in ('โรงพยาบาลชุมชน') AND p.positionrole = 'นักจิตวิทยา'AND p.positiontypeID = '4' THEN 1 ELSE 0 END) AS 'PA03_1',
  SUM(CASE WHEN hn.HOS_TYPE in ('โรงพยาบาลส่งเสริมสุขภาพตำบล','ศูนย์บริการสาธารณสุข อปท.') AND p.positionrole = 'นักจิตวิทยา'AND p.positiontypeID = '4' THEN 1 ELSE 0 END) AS 'PA04_1',
  SUM(CASE WHEN hn.HOS_TYPE in ('กรมสุขภาพจิต')AND p.positionrole = 'นักจิตวิทยาคลินิก'AND p.positiontypeID = '4' THEN 1 ELSE 0 END) AS 'PA01_2',
  SUM(CASE WHEN hn.HOS_TYPE in ('โรงพยาบาลศูนย์','โรงพยาบาลทั่วไป')AND p.positionrole = 'นักจิตวิทยาคลินิก'AND p.positiontypeID = '4' THEN 1 ELSE 0 END) AS 'PA02_2',
  SUM(CASE WHEN hn.HOS_TYPE in ('โรงพยาบาลชุมชน') AND p.positionrole = 'นักจิตวิทยาคลินิก'AND p.positiontypeID = '4' THEN 1 ELSE 0 END) AS 'PA03_2',
...
WHERE 
  pt.positiontypeID = '4'  -- แก้ไขให้ตรงกับเงื่อนไขใน SELECT
  AND pt.Mcatt1 = 'ใช่'
";
if (isset($_POST['Year'])) {
	$Year = $_POST['Year']-543;
...
if (isset($_POST['Year'])) {
  ...
  if (isset($_POST['CODE_PROVINCE'])) {
    ...
    if ($_POST['CODE_HOS']<> 'ทั้งหมด') {
    $CODE_HOS = $_POST['CODE_HOS'];
    $MOOsql1p = $MOOsql1p."AND hn.HospitalID = '".$CODE_HOS."'" ;
    }
    } 
   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              <h3> ข้อมูลทรัพยากร MCATT นักจิตวิทยา</h3>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
			<form class="form-valide" action="dashboard08heart.php" method="post" id="myform1" name="foml">  
      <div class="row">
      <div class="col-md-2">
              ...
              <div class="col-md-2">
               <div class="form-group">
                  ...
                  <select name="position" class="form-control select2" id="position" style="width: 100%;">
                    ...
                    <option selected="selected" value="นักจิตวิทยา" >นักจิตวิทยา</option>
			...
			<div class="col-lg-6">
				...
				<div class="small-box" style="background-color: #e7cdc2; color: black;">
				  <div class="inner">
                    ...
                    <p>นักจิตวิทยา</p>
					<h3><?php echo number_format($TC01, 0, '.', ',');?> คน</h3>
                    <!--<p>xx : 1แสน ประชากร</p>-->
				...
				<div class="small-box" style="background-color: #e7cdc2; color: black;">
				  <div class="inner">
                    ...
                    <p>นักจิตวิทยาคลินิก</p>
					          <h3><?php echo number_format($TC02, 0, '.', ',');?> คน</h3>
                    <!--<p>xx : 1แสน ประชากร</p>-->
