          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header bg-olive color-palette">
                <h3 class="card-title">ข้อมูลการรักษาด้วยไฟฟ้า (ECT)</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <thead>
                   <tr>
					 <?php /* <th>#</th>
					  ...
					  <th>การรักษาด้วยไฟฟ้า (ECT)</th>
					  <?php /* <th>จำนวน (เครื่อง)</th> */ ?>
					  <th>การรักษาด้วย Transcranial Magnetic Stimulation (TMS)</th>
					 <?php /* <th>จำนวน (เครื่อง)</th>	*/ ?>
            ...
            */ ?>
						<td><?php echo $rowpersonnel['ect'];?></td>
						<?php /* <td><?php echo $rowpersonnel['ect_no']; ?></td> */ ?>
						<td><?php echo $rowpersonnel['tms'];?></td>
						<?php /* <td><?php echo $rowpersonnel['tms_no']; ?></td> */ ?>
						<?php if($_SESSION["TypeUser"] == "Admin"){?>
						<td><center>
							<!--
							...
							<a href="personnel_del.php?ectID=<?=$rowpersonnel['ID'];?>&&t=0;&&detail=ect">
