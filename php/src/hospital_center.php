		    ...
		    <div class="card card-outline card-dark">
				...
				<div class="card-body">
					...
					-->
							...
							<div class="col-md-5">
									  <input name="number_patients_18" type="text" class="form-control" id="number_patients_18" placeholder="(ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0) ถ้าไม่มีใหีใส่ 0 " required>
								  </div>
								  <div class="col-md-2">คน</div>
							</div>
	...
	<form method="post" enctype="multipart/form-data" name="form1" id="form1" action="ServiceForm_center_update.php">
      ...
      <div class="card card-info card-outline">
		  ...
		  <div class="card-body">			  
		    ...
		    <div class="card card-outline card-dark">
				<div class="card-header">
					<h3 class="card-title">จำนวนผู้รับบริการ ปีงบประมาณ 2566 (ถ้าไม่มีข้อมูลให้ใส่ NA ถ้าไม่มีจำนวนผู้ป่วยให้ใส่ 0)</h3>
					<div class="card-tools">
						<button type="button" class="btn btn-tool" data-card-widget="collapse">
						<i class="fas fa-minus"></i>
						</button>
