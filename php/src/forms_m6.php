		...
		<div class="row"> 
			<div class="col-md-4">
				<div class="form-group">
					...
					<input name="position_other" type="text" class="form-control" id="position_other" placeholder="กรอกตำแหน่ง" required>
					<div class="invalid-feedback" style="font-size: 100%">
						โปรดกรอกตำแหน่ง
					</div>
				</div>
		  ...
		  <div class="col-md-8">
			  <div class="form-group">
				<label><i class="fas fa-file-alt"></i>&nbsp;&nbsp;&nbsp;การอบรมเฉพาะทาง</label>
			  	<br>
				  <div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="training_1" name="training" value="ไม่เคยผ่านการอบรมเฉพาะทาง" onclick="disableTxt();" required>
					<label class="custom-control-label" for="training_1"></label>ไม่เคยผ่านการอบรมเฉพาะทาง
			    </div>
				  <div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="training_2" name="training" value="ด้านสุขภาพจิตและจิตเวช" onclick="disableTxt();" required>
					<label class="custom-control-label" for="training_2"></label>ด้านสุขภาพจิตและจิตเวช
			    </div>
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="training_3" name="training" value="ด้านยาเสพติด" onclick="disableTxt();"required>
					<label class="custom-control-label" for="training_3"></label>ด้านยาเสพติด
			    </div>
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="training_4" name="training" value="อื่น ๆ" onclick="enableTxt();" required>
					<label class="custom-control-label" for="training_4"></label>อื่น ๆ
					<div class="invalid-feedback" style="font-size: 100%">โปรดเลือกการอบรมเฉพาะทาง</div>
			    </div> 	
				<div class="col-6" style="margin-top: 10px;">
