...
$sql1 = "SELECT
    SUM(CASE WHEN personnel.positiontypeID = '6' THEN 1 ELSE 0 END) AS TC01
FROM
    personnel
...
$sql2 = "SELECT
  SUM(CASE WHEN hn.HOS_TYPE in ('กรมสุขภาพจิต')AND p.positiontypeID = '6' THEN 1 ELSE 0 END) AS 'MA01',
...
$MOOsql1 = "SELECT
  hn.CODE_HMOO,
  SUM(CASE WHEN p.positiontypeID = '6' THEN 1 ELSE 0 END) AS 'PA01_1'
FROM
  hospitalnew hn 
LEFT JOIN personnel p ON hn.CODE5 = p.HospitalID
WHERE
...
SELECT
  hg.CODE_PROVINCE,
  hg.HospitalGroup,
  COUNT(CASE WHEN pt.positiontypeID = '6' THEN 1 END) AS MD01
FROM
  HospitalGroups hg
   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              <h3> ข้อมูลทรัพยากร MCATT นักกิจกรรมบำบัด</h3>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
			<form class="form-valide" action="dashboard08physical-therapy.php" method="post" id="myform1" name="foml">  
      <div class="row">
      <div class="col-md-2">
			  ...
			  <div class="col-md-2">
               <div class="form-group">
                  ...
                  <select name="position" class="form-control select2" id="position" style="width: 100%;">
                    ...
                    <option selected="selected" value="นักกิจกรรมบำบัด" >นักกิจกรรมบำบัด</option>
    ...
    <div class="col-md-12 col-sm-12 col-12">
	  <div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">นักกิจกรรมบำบัดปฏิบัติงานวิกฤตสุขภาพจิต (MCATT) จำแนกตามระดับ﻿</h3>
				</div>
      ...
      <div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">นักกิจกรรมบำบัดปฏิบัติงานวิกฤตสุขภาพจิต (MCATT) รายเขตสุขภาพ﻿</h3>
				</div>
				<div class="card-body">
