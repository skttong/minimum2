					...
					<div class="col-xl-12">
						<nav class="navbar navbar-expand-lg">
							<a class="navbar-brand" href="index.html">
								<img id="logo" src="../images/DMH.png" style="width: 80px;" alt="Logo">
							</a>
			...
			<div class="row">
				<div class="mx-auto col-lg-9 col-xl-9 col-md-10">
					<div class="text-center hero-content">
						<h1 class="mb-30 wow fadeInUp" data-wow-delay=".2s" style="font-size:38px;">ข้อมูลโรงพยาบาลด้านสุขภาพจิตและจิตเวช</h1>
						<p class="wow fadeInUp" data-wow-delay=".4s">กรมสุขภาพจิต</p><br>
<!--
...
-->
	...
	<section class="latest-product-area pt-50 pb-110">
		<div class="container">
			<div class="row">
