...
if (isset($data)) {
  ...
  $sql = "DELETE FROM HDCTB15 WHERE b_year = ".$YEAR;
    ...
    $stmt = mysqli_prepare($con, "INSERT INTO HDCTB15(id, hospcode, areacode, date_com, b_year, pop, k, target, result1, result2, result3, result4) 
  VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");
  ...
  file_put_contents('/var/www/html/log.txt', "True HDCTB15 Script run at: " . date('Y-m-d H:i:s') . "\n", FILE_APPEND);
}
