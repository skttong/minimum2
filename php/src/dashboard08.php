...
ORDER BY hospitalnew.CODE_HMOO DESC;";
    ...
    <div class="row">
        ...
        const myChart3 = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['เขตสุขภาพจิต 1', 'เขตสุขภาพจิต 2', 'เขตสุขภาพจิต 3', 'เขตสุขภาพจิต 4', 'เขตสุขภาพจิต 5', 'เขตสุขภาพจิต 6', 'เขตสุขภาพจิต 7', 'เขตสุขภาพจิต 8', 'เขตสุขภาพจิต 9', 'เขตสุขภาพจิต 10', 'เขตสุขภาพจิต 11', 'เขตสุขภาพจิต 12', 'เขตสุขภาพจิต 13'],
                datasets: [{
