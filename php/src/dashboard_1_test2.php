        ...
        <div class="card card-default">
          ...
          <div class="card-body">
			...
			<div class="card-footer">
				  <button type="submit" class="btn btn-primary"> ค้นข้อมูล &nbsp;<i class="fa fas fa-plus"></i></button>
      ...
      <div class="row">
		<div class="col-md-6">
			<div class="card">
				...
				<div class="card-body">
					<canvas id="myChart3" style="min-height: 100%; height: 380px; max-height: 380px; max-width: 100%;"></canvas>
					<script>
						 const ctx3 = document.getElementById('myChart3');
						  ...
						  data: {
							...
							{
							  label: "อบรมจิตแพทย์เด็กและวัยรุ่น",
							  type: "bar",
							  stack: "Base2",
							  ...
							  label: "อบรมแพทย์เวชศาสตร์ป้องกันสุขภาพจิตชุมชน (อว. กับ วว.)",
							  type: "bar",
							  stack: "Sensitivity",
		...
		<div class="col-md-6">
			<div class="card">
				...
				<div class="card-body">
					...
					<canvas id="myChart4" style="min-height: 100%; height: 380px; max-height: 380px; max-width: 100%;"></canvas>
					<script>
						 const ctx4 = document.getElementById('myChart4');
						  ...
						  data: {
							...
							datasets: [{
							  ...
							  label: "อบรมการพยาบาลเฉพาะทางจิตเวชสุขภาพจิตและจิตเวช (จิตเวชผู้ใหญ่)",
							  type: "bar",
							  stack: "Base",
							  backgroundColor: '#bd6f58',
							  borderColor: 	'#bd6f58',
							...
							{
							  label: "อบรมการพยาบาลเฉพาะทางจิตเวชเด็กและวัยรุ่น",
							  type: "bar",
							  stack: "Base2",
							  backgroundColor: '#b158bd',
							  borderColor: 	'#b158bd',
							  ...
							  label: "อบรมการพยาบาลเฉพาะทางผู้ใช้ยาและสารเสพติด",
							  type: "bar",
							  stack: "Sensitivity",
							  backgroundColor: '#58bd8d',
							  borderColor: 	'#58bd8d',
...
<?php /*?>	   <!-- =========================================================== -->
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box bg-info">
              <span class="info-box-icon"><i class="fas fa-pills" style="color: black;"></i></span>

              <div class="info-box-content">
				<span class="info-box-text">ข้อมูลเภสัชกร</span>
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box bg-success">
              <span class="info-box-icon"><i class="fas fa-user-md" style="color: black;"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">ข้อมูลนักสังคมสงเคราะห์</span>
                <span class="info-box-number"><?php echo $row5['total'] ;?></span> 
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box bg-warning">
              <span class="info-box-icon"><i class="fas fa-users" style="color: black;"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">ข้อมูลนักกิจกรรมบำบัด</span>
                <span class="info-box-number"><?php echo $row6['total'] ;?></span> 
         ...
         <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box bg-danger">
              <span class="info-box-icon"><i class="fas fa-comments" style="color: black;"></i></span>

             <div class="info-box-content">
				<span class="info-box-text">ข้อมูลนักจิตวิทยาคลินิก</span>
				<span class="info-box-number"><?php echo $row4_1['total'] ;?></span>  
	 ...
	 <!-- =========================================================== -->
       <!-- <h5 class="mt-4 mb-2">Info Box With <code>bg-*</code></h5>-->
        <div class="row">
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box" style="background-color: #FF7D63;">
              <span class="info-box-icon"><i class="far fa-bookmark"></i></span>

              <div class="info-box-content">
				<span class="info-box-text">นักจิตวิทยา</span>
				<span class="info-box-number"><?php echo $row4_2['total'] ;?></span>  
          ...
          <!-- /.col -->
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box" style="background-color: #3385ff;">
              <span class="info-box-icon"><i class="fas fa-diagnoses"></i></i></span>

              <div class="info-box-content">
                <span class="info-box-text">ข้อมูลนักสื่อความหมาย</span>
                <span class="info-box-number"><?php echo $row7['total'];?></span> 
          ...
          <!-- /.col -->
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box" style="background-color: #e699ff;">
              <span class="info-box-icon"><i class="far fa-calendar-alt"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">ข้อมูลนักวิชาการศึกษาพิเศษ</span>
                <span class="info-box-number"><?php echo $row8['total'] ;?></span> 
	...
	<!-- =========================================================== -->
      ...
      <div class="row">
		<div class="col-md-8 col-sm-8 col-8">
			<div class="card">
				...
				<div class="card-body" align="center">
					...
					<canvas id="myChart9" style="min-height: 400px; height: 400px; max-height: 400px; max-width: 100%;"></canvas>
		...
		<div class="col-md-4">
					...
					<div class="info-box" style="background-color: #6DBFD1;">
					  <span class="info-box-icon"><i class=" fas fa-file-medical-alt"></i></span>

					  <div class="info-box-content">
						<span class="info-box-text">การรักษาด้วยไฟฟ้า (ECT)</span>
						<span class="info-box-number">จำนวน 5 เครื่อง</span>
						<!--
						<div class="progress">
						  <div class="progress-bar" style="width: 70%"></div>
						</div>
					...
					<div class="info-box" style="background-color: #FF7D63;">
					  ...
					  <div class="info-box-content">
						<span class="info-box-text">การรักษาด้วยTranscranial Magnetic Stimulation (TMS)</span>
						<span class="info-box-number">จำนวน 4 เครื่อง</span>
						<!--
						<div class="progress">
						  <div class="progress-bar" style="width: 70%"></div>
						</div>
