...
if (isset($data)) {
  ...
  $sql = "DELETE FROM HDCTB03 WHERE b_year = ".$YEAR;
  ...
  $stmt = mysqli_prepare($con, "INSERT INTO HDCTB03(id, hospcode, areacode, date_com, b_year, groupcode, total, ofc, sss, ucs, nrd, oth, v_total, v_ofc, v_sss, v_ucs, v_nrd, v_oth) 
                VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
