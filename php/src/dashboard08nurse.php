...
function myFunction2() {
    ...
    <div class="row">
      ...
      <div class="row">
          ...
          <p>พยาบาลเฉพาะทางผู้ใช้ยาและสารเสพติดระยะสั้น 10 วัน</p>
      ...
      <div class="row">
        ...
        const myChart3 = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['พยาบาลเฉพาะทางสุขภาพจิตและจิตเวช', 'พยาบาลเฉพาะทางจิตเวชเด็กและวัยรุ่น', 'พยาบาลเฉพาะทางผู้ใช้ยาและสารเสพติด', 'พยาบาลเฉพาะทางผู้สูงอายุ','การพยาบาลเฉพาะทางผู้ใช้ยาและสารเสพติด ระยะสั้น 10 วัน','อื่น ๆ','ยังไม่ผ่านการอบรมเฉพาะทาง'],
                datasets: [{
                    label: 'ปฏิบัติงาน',
