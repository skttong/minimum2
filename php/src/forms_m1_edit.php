		...
		<div class="row"> 
		  <div class="col-md-4">
			  <div class="form-group">
				  ...
				  <input name="firstname" type="text" class="form-control" id="firstname" placeholder="กรอกชื่อจริง" value="<?php echo $row1['firstname'] ;?>"  required>
				  <div class="invalid-feedback" style="font-size: 100%">
					  โปรดกรอกชื่อจริง
				  </div>
			  </div>
		  ...
		  <div class="col-md-4">
			  <div class="form-group">
                  ...
                  <input name="lastname" type="text" class="form-control" id="lastname" placeholder="กรอกนามสกุล" value="<?php echo $row1['lastname'] ;?>"  required>
				  <div class="invalid-feedback" style="font-size: 100%">
					  โปรดกรอกนามสกุล
				  </div>
			  </div>
