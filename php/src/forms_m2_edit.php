		  ...
		  <div class="col-md-8">
			  <div class="form-group">
				...
				<label><i class="fas fa-file-alt"></i>&nbsp;&nbsp;&nbsp;กำลังศึกษา (สถานะกำลังศึกษา)</label><!--<span style="color:red;"> (กรณี<u> ไม่ได้กำลังศึกษา </u>กดปุ่มบันทึกข้อมูล)</span>--> 
			  	<br>
				  <div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="statuscong0" name="statuscong" value="ไม่ได้กำลังศึกษา" checked onclick="disablestatuscong2();" >
		  ...
		  <div class="col-md-8">
			  <div class="form-group">
				<label><i class="fas fa-file-alt"></i>&nbsp;&nbsp;&nbsp;ปฏิบัติงานหลัก</label><label style="color:red;">*</label>
			  	<br>
				  <div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="opdipd3" name="opdipd" value="2" onclick="toggleDiv2(false)" required <?php if($opdipd == "2"){echo 'checked';} ?> >
					<label class="custom-control-label" for="opdipd3"></label>ไม่ได้ปฏิบัติงานใน OPD และ IPD
			    </div>
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="opdipd1" name="opdipd" value="0" onclick="toggleDiv2(false)" required <?php if($opdipd == "0"){echo 'checked';} ?> >
					<label class="custom-control-label" for="opdipd1"></label>ปฏิบัติงานหลักใน OPD สุขภาพจิต จิตเวชและยาเสพติด
			    </div>
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="opdipd2" name="opdipd" value="1" onclick="toggleDiv2(true)" required <?php if($opdipd == "1"){echo 'checked';} ?> >
