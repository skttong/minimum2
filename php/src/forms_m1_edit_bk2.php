...
*ตัวเลือก*</label>-->
				...
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="r1-1" name="r1" value="แพทย์เวชศาสตร์ป้องกันสุขภาพจิตชุมชน (อว. หรือ วว.)" onclick="disableTxt2();"
                    <?php if($row1['r1'] == "แพทย์เวชศาสตร์ป้องกันสุขภาพจิตชุมชน (อว. หรือ วว.)"){echo 'checked';} ?> required>
					<label class="custom-control-label" for="r1-1"></label>แพทย์เวชศาสตร์ป้องกันสุขภาพจิตชุมชน (อว. หรือ วว.)
			    </div>
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="r1-2" name="r1" value="จิตแพทย์ทั่วไป" onclick="disableTxt2();"  
                    <?php if($row1['r1'] == "จิตแพทย์ทั่วไป"){echo 'checked';} ?> required>
					<label class="custom-control-label" for="r1-2"></label>จิตแพทย์ทั่วไป
			    </div>
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="r1-3" name="r1" value="จิตแพทย์เด็กและวัยรุ่น"  onclick="disableTxt2();"
                    <?php if($row1['r1'] == "จิตแพทย์เด็กและวัยรุ่น"){echo 'checked';} ?> required>
				...
				<div class="custom-control custom-radio">
                    ...
                    <?php if($row1['r1'] == "แพทย์สาขาอื่น ที่ปฏิบัติงานด้านจิตเวชผู้ใหญ่และจิตเวชเด็กและวัยรุ่น"){echo 'checked';} ?> required>
				...
				<br>
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="r1-5" name="r1" value="กำลังศึกษา" onclick="disableTxt2();" 
                    <?php if($row1['r1'] == "กำลังศึกษา"){echo 'checked';} ?> required>
    ...
    <script>
        ...
        <div class="card-footer" align="right">
          <button type="submit" class="btn btn-primary"> แก้ไขข้อมูล &nbsp;<i class="fa fas fa-plus"></i></button>
