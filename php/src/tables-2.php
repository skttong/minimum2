                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                   <tr>
					  ...
					  <th>Psychiatric Ward</th>
					  <th>จำนวน(เตียง)</th>	
					  <th>Psychiatric Unit</th>
					  <th>จำนวน(เตียง)</th>			
					  <th>Integrated Bed</th>
					  <th>จำนวน(เตียง)</th>	
                   ...
                   <tbody>
					 ...
					 if($HosType == "กรมสุขภาพจิต"){ 
				  			$sqlpersonnel = "SELECT bed.bedID, bed.hospitalCode5, bed.Wardall, bed.Ward_no, bed.Unit, bed.Unit_no, bed.Integrate, bed.Integrate_no, bed.bedDate ,hospitalnew.HOS_NAME FROM bed join hospitalnew ON hospitalnew.CODE5 = bed.hospitalCode5 
					...
					<tr>
						...
						<td><?php echo $rowpersonnel['Wardall'];?></td>
						<td><?php echo $rowpersonnel['Ward_no']; ?></td>
						<td><?php echo $rowpersonnel['Unit'];?></td>
						<td><?php echo $rowpersonnel['Unit_no']; ?></td>
						<td><?php echo $rowpersonnel['Integrate'];?></td>
						<td><?php echo $rowpersonnel['Integrate_no']; ?></td>
						<?php if($_SESSION["TypeUser"] == "Admin"){?>
						<td><center>
							<!--
