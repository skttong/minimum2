		  ...
		  <div class="col-md-8">
			  <div class="form-group">
				...
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="training_1" name="training" value="ผ่านการอบรมหลักสูตรนักสังคมสงเคราะห์จิตเวช" required
				...
				<div class="custom-control custom-radio">
					<input type="radio" class="custom-control-input" id="training_2" name="training" value="ยังไม่ผ่านการอบรมหลักสูตรนักสังคมสงเคราะห์จิตเวช" required
		  ...
		  <div class="col-md-8">
			  <div class="form-group">
				...
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="regislaw" name="regislaw" value="YL"
						   <?php if($row1['regislaw'] == "YL"){echo 'checked';} ?>>
						<label class="custom-control-label" for="regislaw"></label>ขึ้นทะเบียนนักสังคมสงเคราะห์ตามประมวลผลกฏหมายวิธีพิจารณาความอาญา (สืบพยานเด็ก)
				</div>
